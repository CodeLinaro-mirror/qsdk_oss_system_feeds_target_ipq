...
define Profile/QSDK_Premium
	...
	PACKAGES:=$(OPENWRT_STANDARD) $(KPI) $(TEST_TOOLS) $(UTILS) $(COREBSP_UTILS) $(MINIDUMP) \
		...
		$(IGMPSNOOPING_RSTP) $(NSS_FLS) $(NSS_L2TP) $(NSS_MACSEC) $(NSS_UDP_ST) $(NSS_NSM)
#		$(QMSCT_CLIENT) \
#		$(HYFI) \
...
define Profile/QSDK_512
	...
	PACKAGES:=$(OPENWRT_STANDARD) $(AUDIO) \
		...
		$(HYFI) kmod-qca-hyfi-bridge $(EMESH_SP) \
		$(QCA_EZMESH) kmod-macvlan $(MINIDUMP)
endef

#       $(MHI_QRTR) $(NSS_COMMON) $(NSS_STANDARD) $(SWITCH_SSDK_PKGS) $(HW_CRYPTO) $(QCA_RFS)
#       $(IGMPSNOOPING_RSTP) $(QCA_ECM_PREMIUM) $(NSS_PPE) $(NSS_USERSPACE_OSS) (NSS_MACSEC)
#       $(NSS_CRYPTO) $(NSS_CLIENTS_STANDARD) $(NSS_EIP197_FW) $(NSS_USERSPACE) $(NSS_RMNET)
#       $(RSRC_MGR) $(NSS_L2TP)
