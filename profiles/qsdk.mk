...
WIFI_OPEN_PKGS:= kmod-ath12k kmod-ath11k wpad-mesh hostapd-utils \
	control-app-open sigma-dut-open wpa-cli qca-wifi-scripts cnssdiag
...
WIFI_PKGS_6_1:=kmod-qca-wifi-unified-profile \
	...
	qca-wifi-scripts sigma-dut qca-acfg
...
define Profile/QSDK_Open
	...
	PACKAGES:=$(OPENWRT_STANDARD) $(STORAGE) $(TEST_TOOLS) $(AUDIO) $(VIDEO) \
		...
		$(WIFI_OPEN_PKGS) $(USB_ETHERNET) $(NSS_STANDARD) $(NSS_MESH) $(EMESH_SP) $(NPT66)\
